...
const HRInterviewSimulator = ({
  ...
  const [interviewType] = useState<string>("HR");
...
Start with a welcoming introduction and your first question.`;
      ...
      const initialLog: LogEntry[] = [
        {
          ...
          text: `Starting HR interview simulation...`,
          timestamp: Date.now(),
        },
        {
      ...
      toast({
        ...
        description: "This is an HR interview.",
      });
    } catch (error: any) {
...
9. Overall recommendation for the HR role`;
        ...
        toast({
          ...
          description: "Your HR interview session has concluded.",
        });
      } else {
    ...
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <p className="text-center text-muted-foreground">
          Enter your details to begin your AI-powered HR interview simulation
        </p>
      </CardHeader>
  ...
  const renderFeedback = () => (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <p className="text-center text-muted-foreground">
          Your HR interview session has concluded. Review the conversation
          below.
        </p>
      </CardHeader>
      <CardContent className="space-y-4">
