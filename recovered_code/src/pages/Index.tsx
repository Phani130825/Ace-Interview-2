  ...
  const renderCurrentView = () => {
    switch (currentView) {
      ...
      case "interview": {
        ...
        const navId =
          typeof window !== "undefined"
            ? window.localStorage.getItem("navInterviewId")
            : null;
              ...
              <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                    Get a full preview of our AI-powered interview preparation
                    system. Experience each module and see how they work
                    together to transform your interview skills.
                  </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6 max-w-6xl mx-auto">
                  ...
                  >
                    <div className="text-2xl">📝</div>
                    <div>
                      <div className="font-semibold">PDF Generator</div>
                      <div className="text-sm opacity-75">AI Resume to PDF</div>
                    </div>
                  </Button>
                ...
                <div className="grid md:grid-cols-4 gap-8">
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Professional interview preparation powered by artificial
                      intelligence.
                    </p>
                  </div>
                  <div>
